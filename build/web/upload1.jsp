<%-- 
    ...
    Author     : anchuakhila
Loaded inputs uploaded to specified folder.......
Call functions:.....PATH CHANGE REQUIRED........
        TakeInput.readSubDetails
        TakeInput.readTchrDetails
        TakeInput.readTSCD
        for each deprtment........
--%>
   ...
   if ((contentType.indexOf("multipart/form-data") >= 0)) {
     ...
     // out.println("</body>");
      //out.println("</html>");
        ...
        TakeInput.readSubDetails("D:\\syllabusformat.xlsx");
        TakeInput.readTchrDetails("D:\\CSInput.xlsx");
        TakeInput.readTSCD("D:\\CSInput.xlsx");
        //TakeInput.writeXLSXFile();
        //TakeInput.laballoc("S:\\lab1.xlsx");
       //Generate.interDept();
       //TakeInput.display();
%>
<form method="post" action="result.jsp" enctype="multipart/form-data">
    <a href="lab1.xlsx">Lab allocation template</a>
    <p color="#0000">Upload lab allocation file</p>
    <input type="file" name="lab" value="" />
